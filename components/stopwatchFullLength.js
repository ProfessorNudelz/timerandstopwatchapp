...
class StopwatchFullLength extends Component {
  state = {
    timerOn: false,
    timerStart: 0,
    timerTime: 0
    ...
    return (
      <div>
        {/* <div className="stopwatch">
          <div className="stopwatch-full-length-header text-center">Stopwatch</div>
        </div> */}
        <div className="stopwatch-full-length-display text-center">
...
export default StopwatchFullLength